...
a. feed Cyril and give a compliment to Angus
   \x.(feed(x,cyril) & exists y.(give(x,y,angus) & compliment(y)))

b. be loved by everyone
   \x.(all y.(love(y,x)))

c. be loved by everyone and detested by no-one
   \x.(all y.(love(y,x)) & ¬(exists y.(detest(y,x))))

====================================================================

3. λx.all y.(dog(y)) ⇒ chase(x,y))

4. λz x.exists y.(present(y) ∧ give(x,y,z))
